...
const EditProfile = () => {
    ...
    if (isConnected == false) {
        return (
            <InterNetError labels={"Edit Profile"} />
        )
    } else {

        return (
            <ScrollView style={{ backgroundColor: 'white', paddingBottom: hp(5) }}>
                <Headerr secndheader={true} label='Edit Profile' />
                <ScrollView style={{ width: wp(95), alignSelf: 'center' }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ marginTop: hp(3), width: wp(95) }}>
                        ...
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
                            ...
                            <View
                                style={{ width: wp(95), }} >
                                <TextInput value={email} editable={false} placeholder='Enter Your Phone Email' placeholderTextColor={'gray'} style={[styles.inputfildeStyle, { backgroundColor: "#eee" }]} />
                            </View>
                        </View>
                        <View style={{ width: wp(95), marginTop: hp(2) }}>
...

                        {
                            ...
                            <View style={{ width: wp(95), marginTop: hp(2) }}>
                                ...
                                <TextInput editable={false} onChangeText={(e) => setSpecialization(e)} value={specialization} placeholder='Enter Your specialization' placeholderTextColor={'gray'}
                                    style={styles.inputfildeStyle} />
                            </View>
                        }
                        ...
                        <TouchableOpacity onPress={() => handleSubmit()} style={{ width: wp(95), height: hp(5), backgroundColor: '#50B148', borderRadius: 5, alignItems: 'center', justifyContent: 'center', alignSelf: "center", marginVertical: 25 }}>
                            <Text style={{ fontSize: hp(1.8), color: 'white', fontFamily: mainFontmedium }}>Submit</Text>
                        </TouchableOpacity>

                        <View style={{ borderWidth: .5, borderColor: "gray", borderRadius: 5, padding: 10 }}>
                            <View style={{ width: wp(95), marginTop: hp(2) }}>
                                <Text style={{ color: 'black', fontSize: hp(1.7), fontFamily: mainFontmedium }}>Old Password</Text>
                                <TextInput onChangeText={(e) => setOldPassword(e)} value={`${oldPassword}`} secureTextEntry maxLength={6} placeholder='Enter Your old password' placeholderTextColor={'gray'}
                            ...
                            <View style={{ width: wp(95), marginTop: hp(2) }}>
                                ...
                                <TextInput onChangeText={(e) => setNewPassword(e)} value={`${newPassword}`} secureTextEntry  maxLength={6} placeholder='Enter Your new password' placeholderTextColor={'gray'}
                                    style={[styles.inputfildeStyle, { width: wp(90), }]} />
                            </View>
                            <View style={{ width: wp(95), marginTop: hp(1.8) }}>
                                ...
                                <TextInput onChangeText={(e) => setConfirmPassword(e)} value={`${confirmPassword}`} secureTextEntry  maxLength={6} placeholder='Confirm Your password' placeholderTextColor={'gray'}
                                    style={[styles.inputfildeStyle, { width: wp(90), }]} />
                            </View>
